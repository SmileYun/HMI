	...
	public Bundle response(CanMsgInfo info) {
		...
		case 0x00: //rew
			if (alaLevel == 0x01) {
				...
				bundlePutInt(bd,R.drawable.rew,
						R.drawable.rew_1,AUDIO,LEVEL1TIME);
				
			} else if (alaLevel == 0x02) {
				
				bundlePutInt(bd,R.drawable.rew,
						R.drawable.rew_2,AUDIO,LEVEL2TIME);
		...
		case 0x01:// fcw
			if (alaLevel == 0x01) {
				...
				bundlePutInt(bd,R.drawable.fcw,
						R.drawable.fcw_1,AUDIO,LEVEL1TIME);
				
			} else if (alaLevel == 0x02) {
				
				bundlePutInt(bd,R.drawable.fcw,
						R.drawable.fcw_2,AUDIO,LEVEL2TIME);
		...
		case 0x02:// icw
			if (alaLevel == 0x01 && dir==0x01) {
				...
				bundlePutInt(bd,R.drawable.icw_left,
						R.drawable.icw_1_left,AUDIO,LEVEL1TIME);
				
			} else if (alaLevel == 0x01
					&& dir==0x02) {
				
				bundlePutInt(bd,R.drawable.icw_right,
						R.drawable.icw_1_right,AUDIO,LEVEL1TIME);
				
			} else if (alaLevel == 0x02
					&& dir==0x01) {
				
				bundlePutInt(bd,R.drawable.icw_left,
						R.drawable.icw_2_left,AUDIO,LEVEL2TIME);
				
			} else if (alaLevel == 0x02
					&& dir==0x02) {
				
				bundlePutInt(bd,R.drawable.icw_right,
						R.drawable.icw_2_right,AUDIO,LEVEL2TIME);
		...
		case 0x03:// cfcw
			if (alaLevel == 0x01) {
				...
				bundlePutInt(bd,R.drawable.cfcw,
						R.drawable.cfcw_1,AUDIO,LEVEL1TIME);
				
			} else if (alaLevel == 0x02) {
				
				bundlePutInt(bd,R.drawable.cfcw,
						R.drawable.cfcw_2,AUDIO,LEVEL2TIME);
		...
		case 0x05:// dnpw
			if (alaLevel == 0x01) {
				...
				bundlePutInt(bd,R.drawable.dnpw,
						R.drawable.dnpw_1,AUDIO,LEVEL1TIME);
				
			} else if (alaLevel == 0x02) {

				bundlePutInt(bd,R.drawable.dnpw,
						R.drawable.dnpw_2,AUDIO,LEVEL2TIME);
		...
		case 0x06:// lcw
			if (alaLevel == 0x01 && dir==0x01) {
				...
				bundlePutInt(bd,R.drawable.lcw_left,
						R.drawable.lcw_1_left,AUDIO,LEVEL1TIME);
				
			} else if (alaLevel == 0x01
					&& dir==0x02) {

				bundlePutInt(bd,R.drawable.lcw_right,
						R.drawable.lcw_1_right,AUDIO,LEVEL1TIME);
				
			} else if (alaLevel== 0x02
					&& dir==0x01) {

				bundlePutInt(bd,R.drawable.lcw_left,
						R.drawable.lcw_2_left,AUDIO,LEVEL2TIME);
				
			} else if (alaLevel == 0x02
					&& dir==0x02) {

				bundlePutInt(bd,R.drawable.lcw_right,
						R.drawable.lcw_2_right,AUDIO,LEVEL2TIME);
